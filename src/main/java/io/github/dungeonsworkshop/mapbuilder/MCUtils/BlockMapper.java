...
public class BlockMapper {
    ...
    private static final ImmutablePair<Integer, String> STONE = new ImmutablePair(1, "minecraft:stone");
    ...
    public static int toJavaIDFromBedrockID(int BID){
        ...
        return JAVA_ID_MAP.inverse().getOrDefault(bNameSpace, 1);
    }

    public static int toBedrockIDFromJavaID(int JID){
        String jNameSpace = JAVA_ID_MAP.getOrDefault(JID, "nomapping: " + JID);
        return BEDROCK_ID_MAP.inverse().getOrDefault(jNameSpace, 1);
    }
